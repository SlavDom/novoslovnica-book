...
\textit{Vëlïk} \textipa{['velik]} (Big) - \textit{Vëlïčina} \textipa{['veli\t{tS}Ina]} (Measure)
...
\textit{Věnec} \textipa{['vIne\t{ts}]} (Crown)- \textit{Věnčati} \textipa{['vIne\t{tS}atI]} (To crown)
...
\textit{Roditi} \textipa{[‘rodit1]} (bare) - \textit{Rođati} \textipa{[‘ro\texttoptiebar{\textctdctzlig}at1]}
