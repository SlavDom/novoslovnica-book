...
\textit{Reproduction\index{reproduction}} (extra sounds) - is a process of adding a new sound (consonant or vowel) in the word.

\textit{Alternation\index{alternation}} - is a process of changing some sound (consonant or vowel) or sounds to another one(s).
