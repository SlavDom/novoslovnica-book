...
\begin{itemize}
	\item The sound \textipa{T} has no pair, because its pair \textipa{D} has never been used in Slavic languages.
	\item Also nasal velar consonant \textipa{N} has no soft pair.
